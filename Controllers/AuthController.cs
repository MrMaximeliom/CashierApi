...
namespace CashierApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        ///     POST /login
        ///     {
        ///        "phoneNumber": "0987876789",
        ///        "password": "password"
        ///     }
        ///
        /// </remarks>
        /// <response code="200">Returns an auth object with valid token and user's details</response>
        /// <response code="400">Returns bad request if phone number or password is not submitted or no user found </response>
        [HttpPost("login")]
